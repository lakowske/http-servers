...
from configuration.app import Config, AdminContext, BuildContext
...
class TestConfigurationLoading:
    ...
    def test_config_with_all_fields(self):
        ...
        config_data = {
            ...
            "imap": {
                "username": "imap@test.com",
                "password": "imap_pass"
            },
            "smtp": {
                "username": "smtp@test.com", 
                "password": "smtp_pass"
            },
            "proxies": [
    ...
    def test_config_merge_functionality(self):
        ...
        base_config = Config(admin=AdminContext(
            domain="base.com",
            email="base@base.com"
        ))
    ...
    def test_config_service_initialization(self):
        ...
        config = Config(admin=AdminContext(
            domain="service.com",
