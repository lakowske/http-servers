...
from services.mail_service import LATEST_IMAGE as MAIL_LATEST_IMAGE
from services.mail_service import MAIL_VOLUME
    ...
    for log_file in log_files:
        ...
        if len(parts) >= 3:
            ...
            if image not in logs_by_image:
                logs_by_image[image] = []
            logs_by_image[image].append({"file": log_file, "timestamp": timestamp, "status": status})
