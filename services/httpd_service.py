...
class HttpdService(PodmanService):
    """
    A service class to interact with a Podman httpd container using a provided
    configuration.
    """
    ...
    def __init__(
        ...
        """
        Initialize the HttpdService with Podman and Config services.
        Args:
    ...
    def run_container(self, image: str, name: str) -> Container:
        ...
        This method runs an httpd container using the client obtained from the
        `get_client` method.
        """
        volumes = {
    ...
    def reload_configuration(self, container_id: str):
        ...
        This method reloads the configuration of the container with the
    ...
    def create_git_repo(self, container_id: str, repo_name: str):
        ...
        cmd = (
            ...
            f" && chown -R www-data:www-data "
            f'/usr/local/apache2/git/{repo_name}"'
        )
